        ...
        <article className="max-w-2xl">
          ...
          >
            <span aria-hidden="true">
              <ParticleMorphText words={['Emergent', 'Adaptive']} interval={4000} fontSize={morphFontSize} gradientFrom={isDark ? '#7b66ff' : '#6024f3'} gradientTo={isDark ? '#d27bfc' : '#a538e5'} startIndex={0} synchronized />
              <span className="text-[var(--color-text-primary)]">intelligence</span>
              <br />
              <span className="text-[var(--color-text-secondary)]">for </span>
              <ParticleMorphText words={['adaptive', 'emergent']} interval={4000} fontSize={morphFontSize} gradientFrom={isDark ? '#d27bfc' : '#a538e5'} gradientTo={isDark ? '#f87bb8' : '#f25b8c'} startIndex={0} nudgeY={0.04} synchronized />
