        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: 'AgentOS',
              alternateName: ['AgentOS Framework', 'AgentOS Runtime', 'AgentOS by Frame'],
              description: 'Open-source TypeScript AI agent framework. Build autonomous agents with cognitive memory, runtime tool generation, multi-agent orchestration, multimodal RAG, voice pipelines, and 11 LLM providers.',
              ...
              featureList: [
                ...
                '11 LLM providers (OpenAI, Anthropic, Google, Ollama, OpenRouter)',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              '@type': 'Organization',
              name: 'Frame',
              alternateName: ['Frame.dev', 'Frame team'],
              url: 'https://frame.dev',
            ...
            <div className="grid md:grid-cols-4 gap-8 mb-8">
              <div>
                ...
                <div className="flex gap-3">
                  <a href="https://github.com/framerslab" target="_blank" rel="noopener noreferrer" className="text-text-secondary hover:text-accent-primary transition-colors" aria-label="FramersLab on GitHub">
                  ...
                  <a href="https://www.linkedin.com/company/framerslab" target="_blank" rel="noopener noreferrer" className="text-text-secondary hover:text-accent-primary transition-colors" aria-label="Frame on LinkedIn">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                    <span className="sr-only">LinkedIn</span>
                  </a>
                  <a href="https://twitter.com/framerslab" target="_blank" rel="noopener noreferrer" className="text-text-secondary hover:text-accent-primary transition-colors" aria-label="FramersLab on Twitter">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li><a href="https://github.com/framerslab/agentos/releases" target="_blank" rel="noopener noreferrer" className="text-text-secondary hover:text-accent-primary transition-colors">{tFooter('releaseNotes')}</a></li>
                  <li><a href="https://github.com/framerslab/agentos" target="_blank" rel="noopener noreferrer" className="text-text-secondary hover:text-accent-primary transition-colors">{tNav('github')}</a></li>
                  <li><a href="https://wilds.ai/discord" target="_blank" rel="noopener noreferrer" className="text-text-secondary hover:text-accent-primary transition-colors">{tFooter('discord')}</a></li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li><a href="https://wunderland.sh" target="_blank" rel="noopener noreferrer" className="text-text-secondary hover:text-accent-primary transition-colors">Wunderland</a></li>
