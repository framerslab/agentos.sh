            ...
            <div className="grid md:grid-cols-4 gap-8 mb-8">
              <div>
                ...
                <div className="flex gap-3">
                  <a href="https://github.com/framerslab" target="_blank" rel="noopener noreferrer" className="text-text-secondary hover:text-accent-primary transition-colors" aria-label="FramersAI on GitHub">
                  ...
                  <a href="https://twitter.com/framerslab" target="_blank" rel="noopener noreferrer" className="text-text-secondary hover:text-accent-primary transition-colors" aria-label="FramersAI on Twitter">
